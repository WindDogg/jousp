...
public class Msqx {
	...
	static String name = "马上清(青)西";
	static String code = "120080";
	static String targetUrl = "E:/work/workspace2016/report/WebRoot/map/json/hd_msqx.json";
	...
	public void gotoJson() throws IOException {
		...
		Double strs[][][] = new Double[5][][];
		List<Double[]> clist = new ArrayList<Double[]>();
		
		List<Map<String, Object>> list1 = MysqlHelper.executeQuery(" select * from hdq_area_lnglat where name = '青龙桥街道' and type = 'jd' ");
		if(list1.size()==1){
		...
		List<Map<String, Object>> list2 = MysqlHelper.executeQuery(" select * from hdq_area_lnglat where name = '上地街道' and type = 'jd' ");
		if(list1.size()==1){
		...
		List<Map<String, Object>> list4 = MysqlHelper.executeQuery(" select * from hdq_area_lnglat where name = '清河街道' and type = 'jd' ");
		if(list1.size()==1){
		...
		List<Map<String, Object>> list5 = MysqlHelper.executeQuery(" select * from hdq_area_lnglat where name = '马连洼街道' and type = 'jd' ");
		if(list1.size()==1){
