...
public class Wgs84ToBaiDu {
	...
	public void go(String filepath) throws IOException {
		...
		FileManager.saveFile("hdjd_new_baidu.json", jsonObject.toJSONString());
	}
	
	public static void main(String[] args) throws IOException {
		Wgs84ToBaiDu obj = new Wgs84ToBaiDu();
		obj.go("E:/work/workspace2016/report/WebRoot/map/json/hdjd_new_wgs84.json");
	}
